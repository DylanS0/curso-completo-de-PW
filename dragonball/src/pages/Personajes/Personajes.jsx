                    ...
                    <div key={item.id} className="col-sm-6 col-md-4 col-lg-3 mb-4">
                        <div className="card ">
                            ...
                            <div className="card-body text-center">
                                ...
                                <p className="text-info"><b>Raza:</b> {item.race}<br />
                                    <b>Ki:</b> {item.ki && item.ki !== "unknown" ? item.ki : "No disponible"}</p>*/}
                                <p className="text-info">
                                    <b>Raza: </b> {item.race} <br />
                                    <b>Ki: </b> <span className="badge text-bg-danger">{item.ki}</span>

                                </p>
                            </div>
                            <div className="card-footer text-center">
                                <a href="#" className="btn btn-outline-info btn-sm me-2" data-bs-toggle="modal" data-bs-target={`#${item.id}`} >Modal</a>
                                <a href="#" className="btn btn-outline-light btn-sm">Detalle</a>
                            </div>
