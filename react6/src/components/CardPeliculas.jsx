        ...
        <div className='col-md-4 col-lg-3 mb-4'>
            <div className='card h-100'>
                ...
                <div className='card-footer text-center'>
                    <div className="card-footer text-center ">
                        <a href="#" className="btn btn-primary me-3" data-bs-toggle="modal" data-bs-target={`#modal${item.id}`}>Modal</a>
                        <a href="#" className="btn btn-primary me-3" data-bs-toggle="modal" >Detalle</a>
